...
| Slow responses, high latency, throughput drop, users reporting "app is slow" | Application performance, Pod runtime, Networking/CNI/LB | Which Deployment/Service? Baseline latency? Any recent rollout or config change? HPA or autoscaling enabled? |
